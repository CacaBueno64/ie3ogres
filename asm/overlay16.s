...
_020EF2A0:
	...
	add sp, sp, #0x28
	ldmfd sp!, {r4, r5, r6, r7, r8, r9, r10, pc}
_020EF2B0: .word gL5Allocator
_020EF2B4: .word gL5Config
...
FUN_ov16_020ef3a0: ; 0x020EF3A0
	...
	moveq r0, #0
	ldmeqfd sp!, {r4, pc}
	ldr r0, _020EF3D0 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, r4
	bl FUN_ov16_020ef2bc
	mov r0, #1
	ldmfd sp!, {r4, pc}
_020EF3D0: .word gL5Allocator
...
_020EF588:
	...
	cmpne r1, #0
	beq _020EF5A0
	ldr r0, _020EF5AC ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
_020EF5A0:
	mov r0, r6
	add sp, sp, #0x94
	ldmfd sp!, {r4, r5, r6, r7, r8, r9, pc}
_020EF5AC: .word gL5Allocator
...
FUN_ov16_020f1214: ; 0x020F1214
	...
	ldr r4, _020F1294 ; =gMainScreenBrightness
	mov r2, r2, lsr #0x10
	mov r3, r3, lsr #0x10
	mov r12, r6
	mov r5, #1
...
_020F1294: .word gMainScreenBrightness
...
FUN_ov16_020f1338: ; 0x020F1338
	...
	cmp r4, #0
	ldreq r0, _020F13A8 ; =gMainScreenBrightness
	ldreq r1, _020F13AC ; =0x0400006C
	ldreqh r0, [r0]
	streqh r0, [r1]
	ldrne r0, _020F13A8 ; =gMainScreenBrightness
	ldrne r1, _020F13B0 ; =0x0400106C
	ldrneh r0, [r0, #2]
	strneh r0, [r1]
	ldmfd sp!, {r3, r4, r5, pc}
_020F13A4: .word unk_0209A160
_020F13A8: .word gMainScreenBrightness
...
FUN_ov16_020f13ec: ; 0x020F13EC
	...
	bl FUN_ov16_020f1214
	cmp r4, #0
	ldreq r0, _020F145C ; =gMainScreenBrightness
	ldreq r1, _020F1460 ; =0x0400006C
	ldreqh r0, [r0]
	streqh r0, [r1]
	ldrne r0, _020F145C ; =gMainScreenBrightness
	ldrne r1, _020F1464 ; =0x0400106C
	ldrneh r0, [r0, #2]
	strneh r0, [r1]
	ldmfd sp!, {r4, pc}
_020F1458: .word unk_0209A160
_020F145C: .word gMainScreenBrightness
...
FUN_ov16_020f2718: ; 0x020F2718
	...
	str r5, [sp]
	mov r2, r0
	ldr r0, _020F2864 ; =gL5Movie
	mov r3, r5
	bl _ZN7L5Movie12FUN_0202e4ccEPtS0_S0_S0_
	bl G2_GetBG0ScrPtr
_020F282C:
	mov r1, r5, lsl #1
	strh r5, [r0, r1]
...
FUN_ov16_020f2868: ; 0x020F2868
	...
	cmp r0, #0
	moveq r6, r4
	ldr r0, _020F2A0C ; =gL5Movie
	mov r2, r4
	mov r3, r4
	str r6, [sp]
	bl _ZN7L5Movie9openMovieEPcmmh
	mov r0, #6
...
_020F2A0C: .word gL5Movie
_020F2A10: .word ov16_02118498
_020F2A14: .word gL5Allocator
...
FUN_ov16_020f2a74: ; 0x020F2A74
	...
	cmp r1, #0
	ldmeqfd sp!, {r3, pc}
	ldr r0, _020F2AA0 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	ldmfd sp!, {r3, pc}
_020F2A9C: .word ov16_02119ED4
_020F2AA0: .word gL5Allocator
...
FUN_ov16_020f2ab4: ; 0x020F2AB4
	...
	ldr r4, _020F2CCC ; =gL5Movie
	ldrh r5, [r1]
	mov r0, r4
	bl _ZN7L5Movie12FUN_0202e784Ev
	cmp r0, #0
	addeq sp, sp, #0x1c
	ldmeqfd sp!, {r4, r5, pc}
	cmp r5, #0xc0
	...
	ldmltfd sp!, {r4, r5, pc}
	mov r0, r4
	bl _ZN7L5Movie12FUN_0202e4ecEv
	mov r1, #0x4000000
	cmp r0, #0
	ldreq r0, [r1]
	biceq r0, r0, #0x1f00
...
FUN_ov16_020f2f58: ; 0x020F2F58
	mul r1, r0, r1
	ldr r0, _020F2F74 ; =gL5Allocator
	ldr r12, _020F2F78 ; =_ZN11L5Allocator8allocateEiii
	mov r1, r1, lsl #5
	mov r2, #0x11
	mov r3, #1
	bx r12
_020F2F74: .word gL5Allocator
_020F2F78: .word _ZN11L5Allocator8allocateEiii
...
FUN_ov16_020f30e8: ; 0x020F30E8
	...
	mov lr, #1
	movne r0, #0
	ldr r12, _020F3168 ; =gL5Allocator
	strb r4, [r5, #8]
	strb lr, [r5, #9]
	strb r0, [r5, #0xa]
	ldr r0, [r12]
...
FUN_ov16_020f3234: ; 0x020F3234
	...
	mov lr, #1
	movne r0, #0
	ldr r12, _020F32B0 ; =gL5Allocator
	strb r4, [r5, #8]
	strb lr, [r5, #9]
	strb r0, [r5, #0xa]
	ldr r0, [r12]
...
FUN_ov16_020f33fc: ; 0x020F33FC
	...
	cmpne r0, #0
	ldmeqfd sp!, {r4, pc}
	ldr r0, _020F3434 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, #0
	str r0, [r4]
	ldmfd sp!, {r4, pc}
_020F3434: .word gL5Allocator
...
_020F34AC:
	...
	mov r4, r0
	ldr r1, [sp, #0x10]
	ldr r0, _020F34EC ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, r4
	add sp, sp, #0x14
	ldmfd sp!, {r4, r5, r6, r7, pc}
_020F34EC: .word gL5Allocator
...
FUN_ov16_020f6c20: ; 0x020F6C20
	...
	str r1, [r4, #4]
	mov r2, #0
	ldr r0, _020F6C48 ; =gL5Allocator
	add r1, r1, r1, lsl #2
	str r2, [r4, #8]
	bl FUN_0202de44
	str r0, [r4, #0xc]
	ldmfd sp!, {r4, pc}
_020F6C48: .word gL5Allocator
...
FUN_ov16_020f6c58: ; 0x020F6C58
	...
	cmp r1, #0
	ldmeqfd sp!, {r3, r4, r5, pc}
	ldr r0, _020F6C88 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	str r4, [r5, #0xc]
	ldmfd sp!, {r3, r4, r5, pc}
_020F6C88: .word gL5Allocator
