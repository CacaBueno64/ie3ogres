...
FUN_ov41_02119fd8: ; 0x02119FD8
	...
	ldr r0, _0211A3DC ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211A444:
	...
	ldr r0, _0211A4D0 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211B1E4:
	cmp r0, #7
	ldmnefd sp!, {r3, r4, r5, r6, r7, pc}
	ldr r0, _0211B2DC ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #1
	ldmeqfd sp!, {r3, r4, r5, r6, r7, pc}
...
FUN_ov41_0211b5ac: ; 0x0211B5AC
	...
	ldr r0, _0211B780 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	addeq r0, r5, #0x1000
...
_0211B9E4:
	...
	ldr r0, _0211BAD0 ; =gSprAnimeCtrl
...
FUN_ov41_0211e818: ; 0x0211E818
	stmfd sp!, {r3, r4, r5, r6, r7, r8, r9, r10, lr}
	sub sp, sp, #4
	ldr r1, _0211EB38 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r1]
...
FUN_ov41_0211eb44: ; 0x0211EB44
	stmfd sp!, {r4, lr}
	ldr r1, _0211EB78 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r1]
	bl FUN_ov16_0210e15c
	cmp r0, #0
...
FUN_ov41_021204fc: ; 0x021204FC
	...
	str r6, [sp, #0xc]
	str r7, [sp, #0x10]
	ldr r5, _021205A4 ; =gSprAnimeCtrl
	ldrb r1, [r4, #0x11]
	ldrh r3, [r4, #0x34]
	ldr r0, [r5]
	mov r2, r7
...
FUN_ov41_021205a8: ; 0x021205A8
	...
	str r3, [sp, #0xc]
	str r2, [sp, #0x10]
	ldr r12, _021205EC ; =gSprAnimeCtrl
	ldrb r1, [r0, #0x11]
	ldrh r3, [r0, #0x34]
	ldr r0, [r12]
	bl FUN_ov16_0210e3f0
...
FUN_ov41_02120950: ; 0x02120950
	...
	mov r9, r0
	str r7, [sp, #0x10]
	ldr r4, _021209EC ; =gSprAnimeCtrl
	ldrb r1, [r9, #0x11]
	ldrh r3, [r9, #0x34]
	ldr r0, [r4]
	mov r2, r7
