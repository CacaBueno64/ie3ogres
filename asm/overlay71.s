...
FUN_ov71_0211aa70: ; 0x0211AA70
	...
	ldr r0, _0211AAF0 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov71_0211ab00: ; 0x0211AB00
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211AB60 ; =gSprAnimeCtrl
	mov r7, r0
	ldr r0, [r2]
	mov r6, r1
	mov r5, #0
...
_0211AC6C:
	...
	str r0, [r4, #8]
_0211AC7C:
	ldr r0, _0211AD00 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r4, pc}
