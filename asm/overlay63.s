...
_02120FEC:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x6e]
	ldr r0, _02121050 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
_02121134:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r9, #0x6c]
	ldr r0, _021211AC ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r9, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov63_02122564: ; 0x02122564
	...
	cmp r1, #5
	ldmnefd sp!, {r3, r4, r5, r6, r7, r8, r9, r10, r11, pc}
	ldr r0, _02123434 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov63_02123764: ; 0x02123764
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0212386C ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r2]
	mov r7, r1
	mov r6, #0
...
FUN_ov63_02123874: ; 0x02123874
	...
	ldr r0, _02123B50 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_02123A6C:
	...
	add r1, r6, #0x90
	bl FUN_ov16_020f316c
	ldr r0, _02123B74 ; =gCameraController
	mov r1, #4
	ldr r5, [r0]
	mov r0, r5
...
_02123B74: .word gCameraController
...
_02123CD0:
	...
	bl FUN_ov63_021201c4
_02123CE4:
	ldr r0, _02123F70 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _02123E84
...
_02123FCC:
	...
	ldr r0, _021240A8 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_021240E0:
	...
	str r2, [sp, #0xc]
	str r2, [sp, #0x10]
	ldr r5, _02124180 ; =gSprAnimeCtrl
	ldrb r1, [r4, #0x11]
	ldrsh r3, [r4, #0x30]
	ldr r0, [r5]
