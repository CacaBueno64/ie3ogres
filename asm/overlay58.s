...
FUN_ov58_02119f00: ; 0x02119F00
	...
	ldr r1, _02119F88 ; =gSprButtonCtrl
	mov r5, r0
	ldr r0, [r1]
	bl FUN_ov16_0210e980
	ldr r0, _02119F8C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_02119F88: .word gSprButtonCtrl
_02119F8C: .word gSprAnimeCtrl
...
FUN_ov58_02119f98: ; 0x02119F98
	stmfd sp!, {r4, lr}
	ldr r1, _02119FD0 ; =gSprButtonCtrl
	mov r4, r0
	ldr r0, [r1]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _02119FD4 ; =gSprAnimeCtrl
	ldr r0, [r0]
	...
	ldmfd sp!, {r4, pc}
_02119FD0: .word gSprButtonCtrl
_02119FD4: .word gSprAnimeCtrl
...
_0211A05C:
	ldr r0, _0211A0CC ; =gSprAnimeCtrl
	ldr r5, _0211A0D0 ; =gDeltaTime
	ldr r0, [r0]
	ldr r1, [r5]
...
_0211A0A0:
	bl _ffix
	ldr r2, _0211A0D4 ; =g3DSpriteCtrl
	mov r1, r0
	ldr r0, [r2]
	...
	ldmfd sp!, {r3, r4, r5, pc}
_0211A0CC: .word gSprAnimeCtrl
_0211A0D0: .word gDeltaTime
_0211A0D4: .word g3DSpriteCtrl
...
FUN_ov58_0211a0d8: ; 0x0211A0D8
	...
	ldr r5, _0211A1E4 ; =gSprButtonCtrl
	ldr r0, [r5]
...
FUN_ov58_0211a1ec: ; 0x0211A1EC
	...
	strb r0, [r5, #0x10f]
	str r1, [sp]
	ldr r0, _0211A3A4 ; =gSprButtonCtrl
	ldrh r1, [r4]
	ldrh r2, [r4, #2]
	ldr r0, [r0]
	add r3, sp, #4
...
_0211A25C:
	strb r1, [r5, #0x10f]
_0211A260:
	ldr r6, _0211A3A4 ; =gSprButtonCtrl
	mov r7, #1
	ldr r0, [r6]
	mov r1, r4
	mov r2, r7
...
_0211A39C:
	add sp, sp, #8
	ldmfd sp!, {r3, r4, r5, r6, r7, pc}
_0211A3A4: .word gSprButtonCtrl
_0211A3A8: .word unk_0209A454
_0211A3AC: .word gAudioPlayer
...
_0211AA60: .word g3DPlaneCtrl
_0211AA64: .word gSprButtonCtrl
...
FUN_ov58_0211ac00: ; 0x0211AC00
	...
	cmp r0, #1
	ldmnefd sp!, {r4, pc}
	ldr r0, _0211AC54 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211ACB4:
	...
	mov r1, #0
	str r1, [sp]
	ldr r0, _0211ACF0 ; =gSprButtonCtrl
	ldrsh r1, [sp, #4]
	ldrsh r2, [sp, #6]
	ldr r0, [r0]
	add r3, sp, #8
...
FUN_ov58_0211b090: ; 0x0211B090
	stmfd sp!, {r4, lr}
	ldr r1, _0211B0C0 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r1]
	bl FUN_ov16_0210e15c
	cmp r0, #0
...
FUN_ov58_0211b0c4: ; 0x0211B0C4
	stmfd sp!, {r3, r4, r5, r6, lr}
	sub sp, sp, #0xc
	ldr r5, _0211B1D4 ; =gSprButtonCtrl
	mov r4, r0
	ldr r0, [r5]
	mov r6, #0
	str r6, [sp, #8]
...
FUN_ov58_0211b280: ; 0x0211B280
	...
	ldmfd sp!, {r3, r4, r5, pc}
_0211B2A4:
	ldr r0, _0211B2B8 ; =gAudioPlayer
	mov r1, #8
	bl _ZN11AudioPlayer12FUN_0202cf6cEm
	str r4, [r5, #0x110]
	ldmfd sp!, {r3, r4, r5, pc}
_0211B2B8: .word gAudioPlayer
...
FUN_ov58_0211b2bc: ; 0x0211B2BC
	...
	mov r1, r5
	bl FUN_ov58_0211a49c
	ldr r4, _0211B304 ; =gSprButtonCtrl
	b _0211B2F8
_0211B2E0:
	ldr r0, [r4]
	mov r1, r5
...
ov58_0211B6A0:
	...
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.global ov58_0211B6C0
ov58_0211B6C0:
	.word FUN_ov58_0211b628
	.word FUN_ov58_0211b614
	.word FUN_ov58_0211a0d8
	.word FUN_ov58_0211a1ec
	.word FUN_ov58_02119f00
	.word _ZN12CommonScreen7vFUN_14Ev
	.word FUN_ov58_02119fd8
	.word FUN_ov58_0211a44c
	.word FUN_ov58_02119f98
