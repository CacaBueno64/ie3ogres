...
FUN_ov37_0211b2c4: ; 0x0211B2C4
	...
	cmp r2, #0xb
	ldrh r5, [r0]
	ldr r4, _0211B4AC ; =gL5Sound
	bne _0211B2F8
	tst r6, #1
	beq _0211B2F8
	ldr r0, _0211B4B0 ; =gL5Movie
...
_0211B4AC: .word gL5Sound
_0211B4B0: .word gL5Movie
