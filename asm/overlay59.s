...
FUN_ov59_0211af3c: ; 0x0211AF3C
	add r0, r0, #0x394
	ldr r12, _0211AF54 ; =MemWrite
	add r0, r0, #0x800
	mov r1, #0
	mov r2, #0x24
	bx r12
_0211AF54: .word MemWrite
...
FUN_ov59_0211b600: ; 0x0211B600
	...
	ldr r0, [r0]
	ldr r12, _0211B61C ; =FUN_02114204
	bx r12
_0211B614: .word 0x02099F38
_0211B618: .word 0x00007FFF
_0211B61C: .word FUN_02114204
...
FUN_ov59_0211b620: ; 0x0211B620
	...
	ldr r0, [r0]
	ldr r12, _0211B63C ; =FUN_02114204
	bx r12
_0211B634: .word 0x02099F38
_0211B638: .word 0x00004210
_0211B63C: .word FUN_02114204
...
FUN_ov59_0211d000: ; 0x0211D000
	...
	mov r2, #0x24
	mla r0, r1, r2, r0
	ldr r12, _0211D018 ; =MemWrite
	mov r1, #0
	bx r12
_0211D018: .word MemWrite
...
FUN_ov59_0211d740: ; 0x0211D740
	ldr r12, _0211D754 ; =MemWrite
	add r0, r0, #0xce0
	mov r1, #0
	mov r2, #0x14
	bx r12
_0211D754: .word MemWrite
...
FUN_ov59_0211e444: ; 0x0211E444
	...
	ldr r12, _0211E458 ; =FUN_0210EFAC
	ldr r0, [r0]
	bx r12
_0211E454: .word 0x02099EB4
_0211E458: .word FUN_0210EFAC
