...
_0211BFFC:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x66]
	ldr r0, _0211C060 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x1c]
...
_0211C12C:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r8, #0x64]
	ldr r0, _0211C1EC ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r8, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x1c]
...
FUN_ov21_0211c688: ; 0x0211C688
	...
	ldr r0, _0211CAEC ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov21_0211cc9c: ; 0x0211CC9C
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211CD64 ; =gSprAnimeCtrl
	mov r7, r0
	ldr r0, [r2]
	mov r6, r1
	mov r5, #0
...
FUN_ov21_0211ce64: ; 0x0211CE64
	...
	ldr r0, _0211D050 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211D10C:
	...
	bl FUN_ov21_0211bc34
_0211D118:
	ldr r0, _0211D1F8 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211D1C4
...
_0211D1C4:
	...
	ldr r1, _0211D1F8 ; =gSprAnimeCtrl
	ldr r2, [r0]
	ldr r0, [r1]
	mov r1, r2, lsl #1
...
FUN_ov21_0211d204: ; 0x0211D204
	...
	ldr r0, _0211D2F8 ; =gSprAnimeCtrl
	ldr r0, [r0]
