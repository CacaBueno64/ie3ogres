...
FUN_ov69_02119f00: ; 0x02119F00
	...
	ldr r0, _0211A0E8 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211A400:
	ldr r0, _0211A5A8 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211B6B4:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x1b8]
	ldr r0, _0211B718 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov69_0211b720: ; 0x0211B720
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211B844 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r2]
	mov r7, r1
	mov r5, #0
...
FUN_ov69_0211bbf0: ; 0x0211BBF0
	...
	ldmnefd sp!, {r3, r4, r5, r6, r7, r8, r9, pc}
_0211BC18:
	ldr r0, _0211BE0C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r3, r4, r5, r6, r7, r8, r9, pc}
...
FUN_ov69_0211c34c: ; 0x0211C34C
	...
	ldr r0, _0211C3A0 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov69_0211c520: ; 0x0211C520
	...
	ldr r4, _0211C590 ; =gSprAnimeCtrl
	mov r5, #4
	ldrb r1, [r6, #0x11]
	ldr r0, [r4]
	mov r2, r5
...
FUN_ov69_0211c9f0: ; 0x0211C9F0
	...
	mov r6, r0
	str r2, [sp, #0x10]
	ldr r4, _0211CA48 ; =gSprAnimeCtrl
	ldrb r1, [r6, #0x11]
	ldrh r3, [r6, #0x34]
	ldr r0, [r4]
