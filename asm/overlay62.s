...
_0211C9C8:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x6a]
	ldr r0, _0211CA2C ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
_0211CB10:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r9, #0x68]
	ldr r0, _0211CB88 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r9, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov62_0211e544: ; 0x0211E544
	...
	and r1, r7, r1
	mov r2, r0, lsl #0x10
	ldr r3, _0211EF10 ; =gSprAnimeCtrl
	mov r1, r1, lsl #0x10
	ldr r0, [r3]
	mov r7, r1, lsr #0x10
	mov r8, r2, lsr #0x10
...
FUN_ov62_0211ef28: ; 0x0211EF28
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211F03C ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r2]
	mov r7, r1
	bl FUN_ov16_0210e15c
...
FUN_ov62_0211f044: ; 0x0211F044
	...
	ldr r0, _0211F25C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov62_0211f270: ; 0x0211F270
	...
	ldr r5, _0211F44C ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r5]
	ldr r1, [r1]
...
_0211F4A0:
	...
	ldr r0, _0211F518 ; =gSprAnimeCtrl
	ldr r0, [r0]
