...
FUN_ov86_0211ac84: ; 0x0211AC84
	...
	ldr r0, _0211ADBC ; =gSprAnimeCtrl
	mov r4, #0
	ldr r0, [r0]
...
FUN_ov86_0211adc4: ; 0x0211ADC4
	...
	ldr r0, _0211B148 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldreq r0, [r6, #0x1c]
...
_0211C7C4:
	...
	ldr r0, _0211C948 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211CA78:
	...
	b _0211C9E4
_0211CA80:
	ldr r0, _0211CB68 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211CAE4
...
FUN_ov86_0211cbb4: ; 0x0211CBB4
	...
	ldr r0, _0211CC50 ; =gSprAnimeCtrl
	ldr r0, [r0]
