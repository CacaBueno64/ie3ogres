...
FUN_ov45_0211b618: ; 0x0211B618
	...
	ldr r2, _0211B82C ; =gSprAnimeCtrl
	ldrh r3, [r3]
	mov r6, r1
	mov r7, r0
	orr r0, r3, r6
...
FUN_ov45_0211b848: ; 0x0211B848
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211B910 ; =gSprAnimeCtrl
	mov r7, r0
	ldr r0, [r2]
	mov r6, r1
	mov r5, #0
...
FUN_ov45_0211b918: ; 0x0211B918
	...
	ldr r0, _0211BAB0 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211BBA4:
	ldr r0, _0211BCAC ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211BC94
...
_0211BD1C:
	...
	ldr r0, _0211BD70 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov45_0211d89c: ; 0x0211D89C
	...
	ldmfd sp!, {r4, r5, r6, pc}
_0211D8D4:
	ldr r0, _0211D9A8 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r4, r5, r6, pc}
...
FUN_ov45_0211d9b4: ; 0x0211D9B4
	...
	ldmfd sp!, {r3, r4, r5, r6, r7, pc}
_0211D9E8:
	ldr r0, _0211DAA4 ; =gSprAnimeCtrl
	mov r7, #0
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
...
_0211DB0C:
	...
	ldr r0, [r0]
	bl FUN_ov16_0210e980
	ldr r0, _0211DC9C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0a0
	mov r0, r4
	ldr r1, [r0]
...
_0211DDBC:
	...
	bl _ZN11AudioPlayer12FUN_0202cf6cEm
_0211DDDC:
	ldr r0, _0211DF44 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211DF28
...
_0211DFC4:
	...
	ldr r0, [r0]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _0211E034 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0d8
	mov r0, r4
	bl FUN_ov45_0211bfe0
...
FUN_ov45_0211fea4: ; 0x0211FEA4
	...
	ldr r0, [r0]
	bl FUN_ov16_0210e980
	ldr r0, _02120020 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0a0
	mov r1, r4
	add r0, r5, #0x36c
...
FUN_ov45_02120030: ; 0x02120030
	...
	add r0, r0, #0x400
	bl FUN_ov16_020f5868
	ldr r5, _021201B0 ; =gSprAnimeCtrl
...
FUN_ov45_021201c0: ; 0x021201C0
	...
	ldr r0, [r0]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _0212028C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0d8
	add r0, r4, #0x39c
	mov r1, #8
