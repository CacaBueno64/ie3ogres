...
FUN_ov132_02143cd0: ; 0x02143CD0
	ldr r12, _02143CDC ; =FUN_020F078C
	mov r0, r1
	bx r12
_02143CDC: .word FUN_020F078C
...
_021461C8: .word 0x0000FFFF
	...
	arm_func_start FUN_021461CC
FUN_021461CC: ; 0x021461CC
	add r0, r0, r1, lsl #1
	add r0, r0, #0x200
	ldrh r0, [r0, #0xe4]
	tst r2, r0
	...
	moveq r0, #0
	bx lr
	arm_func_end FUN_021461CC

	arm_func_start FUN_ov132_021461e8
FUN_ov132_021461e8: ; 0x021461E8
	ldr r12, _021461F4 ; =FUN_021461CC
	mov r2, #1
	bx r12
_021461F4: .word FUN_021461CC
...
FUN_ov132_0215a094: ; 0x0215A094
	...
	add r0, r0, r2, lsl #1
	mov r2, r1, lsl #1
	ldr r12, _0215A0C0 ; =MemWrite
	mov r1, #0
	bx r12
_0215A0C0: .word MemWrite
