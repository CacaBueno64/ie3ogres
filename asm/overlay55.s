...
FUN_ov55_0211baf4: ; 0x0211BAF4
	...
	mov r0, #0xc
	mla r0, r1, r0, r2
	ldr r12, _0211BB08 ; =FUN_020F33FC
	bx r12
_0211BB08: .word FUN_020F33FC
...
FUN_ov55_0211ce90: ; 0x0211CE90
	ldr r12, _0211CEA0 ; =FUN_020F330C
	add r0, r0, #0xa4
	mov r1, #0x14
	bx r12
_0211CEA0: .word FUN_020F330C
...
FUN_ov55_0211d030: ; 0x0211D030
	ldr r12, _0211D040 ; =FUN_020F338C
	add r0, r0, #0xa4
	mov r1, #0x14
	bx r12
_0211D040: .word FUN_020F338C
...
FUN_ov55_0211d09c: ; 0x0211D09C
	...
	mla r0, r1, r3, r0
	ldr r0, [r0, #0xa4]
	ldr r12, _0211D0B4 ; =FUN_020F1138
	mov r1, #0
	bx r12
_0211D0B4: .word FUN_020F1138
...
FUN_ov55_0211d0b8: ; 0x0211D0B8
	...
	mla r0, r1, r3, r0
	ldr r1, [r0, #0xa4]
	ldr r12, _0211D0D0 ; =FUN_020F19D4
	mov r0, #3
	bx r12
_0211D0D0: .word FUN_020F19D4
...
FUN_ov55_0211d0d4: ; 0x0211D0D4
	...
	mla r0, r1, r3, r0
	ldr r1, [r0, #0xa4]
	ldr r12, _0211D0EC ; =FUN_020F19D4
	mov r0, #2
	bx r12
_0211D0EC: .word FUN_020F19D4
...
FUN_ov55_0211d0f0: ; 0x0211D0F0
	...
	mla r0, r1, r3, r0
	ldr r1, [r0, #0xa4]
	ldr r12, _0211D108 ; =FUN_020F19D4
	mov r0, #1
	bx r12
_0211D108: .word FUN_020F19D4
...
FUN_ov55_0211d10c: ; 0x0211D10C
	...
	mla r0, r1, r3, r0
	ldr r1, [r0, #0xa4]
	ldr r12, _0211D124 ; =FUN_020F19D4
	mov r0, #0
	bx r12
_0211D124: .word FUN_020F19D4
...
FUN_ov55_0211d1a4: ; 0x0211D1A4
	...
	ldr r12, _0211D1C0 ; =FUN_020F3054
	add r1, r2, #4
	bx r12
_0211D1BC: .word 0x0211DA64
_0211D1C0: .word FUN_020F3054
