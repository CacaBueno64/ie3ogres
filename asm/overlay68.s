...
FUN_ov68_0211cdbc: ; 0x0211CDBC
	...
	sub sp, sp, #4
	ldr r2, _0211D000 ; =gSprAnimeCtrl
	mov r9, r0
	ldr r0, [r2]
...
FUN_ov68_0211dc58: ; 0x0211DC58
	...
	addne sp, sp, #4
	ldmnefd sp!, {r3, r4, r5, r6, r7, r8, r9, r10, pc}
	ldr r0, _0211E070 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	addne sp, sp, #4
...
FUN_ov68_0211e158: ; 0x0211E158
	...
	ldr r0, _0211E2F4 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211E488:
	...
	b _0211E520
_0211E490:
	ldr r0, _0211E5B0 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211E520
...
_0211E5FC:
	...
	ldmfd sp!, {r4, pc}
_0211E60C:
	ldr r0, _0211E6B4 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r4, pc}
...
FUN_ov68_0211e6bc: ; 0x0211E6BC
	...
	ldr r0, _0211E6F4 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov68_0211e6fc: ; 0x0211E6FC
	...
	str r5, [sp, #0x14]
	str r5, [sp, #0x18]
	ldr r0, _0211E800 ; =gSprAnimeCtrl
	ldr r3, [r4, #0xa4]
	ldr r0, [r0]
	mov r1, r5
	mov r2, r5
...
FUN_ov68_0211e808: ; 0x0211E808
	...
	str r1, [sp, #0x14]
	str r1, [sp, #0x18]
	ldr r0, _0211E920 ; =gSprAnimeCtrl
	ldr r3, [r4, #0xa4]
	ldr r0, [r0]
	mov r2, r1
	bl FUN_ov16_0210e29c
...
FUN_ov68_0211ee44: ; 0x0211EE44
	...
	ldr r12, _0211EE60 ; =_ZN11AudioPlayer12FUN_0202cf6cEm
	mov r1, #1
	bx r12
_0211EE5C: .word gAudioPlayer
_0211EE60: .word _ZN11AudioPlayer12FUN_0202cf6cEm
...
FUN_ov68_0211f2bc: ; 0x0211F2BC
	...
	ldr r12, _0211F2D8 ; =_ZN11AudioPlayer12FUN_0202cf6cEm
	mov r1, #1
	bx r12
_0211F2D4: .word gAudioPlayer
_0211F2D8: .word _ZN11AudioPlayer12FUN_0202cf6cEm
...
FUN_ov68_0211f7e4: ; 0x0211F7E4
	...
	ldr r4, _0211F854 ; =gSprAnimeCtrl
	mov r5, #4
	ldrb r1, [r6, #0x11]
	ldr r0, [r4]
	mov r2, r5
...
FUN_ov68_0211f870: ; 0x0211F870
	...
	mov r8, r0
	str r6, [sp, #0x10]
	ldr r4, _0211F908 ; =gSprAnimeCtrl
	ldrb r1, [r8, #0x11]
	ldrh r3, [r8, #0x34]
	ldr r0, [r4]
	mov r2, r6
...
FUN_ov68_0211f90c: ; 0x0211F90C
	...
	mov r8, r0
	str r6, [sp, #0x10]
	ldr r4, _0211F9A8 ; =gSprAnimeCtrl
	ldrb r1, [r8, #0x11]
	ldrh r3, [r8, #0x34]
	ldr r0, [r4]
	mov r2, r6
