...
_0212FB88: .word 0x0209A2C0
	...
	arm_func_start FUN_0212FB8C
FUN_0212FB8C: ; 0x0212FB8C
	cmp r2, #0
	ldrb r2, [r0, #0x5b]
	orrne r1, r2, r1
	mvneq r1, r1
	...
	strb r1, [r0, #0x5b]
	bx lr
	arm_func_end FUN_0212FB8C

	arm_func_start FUN_0212FBAC
FUN_0212FBAC: ; 0x0212FBAC
	cmp r2, #0
	ldrb r2, [r0, #0x5f]
	orrne r1, r2, r1
	mvneq r1, r1
