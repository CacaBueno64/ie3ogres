...
FUN_ov23_0211b90c: ; 0x0211B90C
	...
	ldr r0, _0211BA40 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov23_0211ba54: ; 0x0211BA54
	...
	ldr r6, _0211BE74 ; =gSprAnimeCtrl
	mov r5, r0
	ldr r0, [r6]
	ldr r1, [r1]
	mov r7, #1
...
_0211BF20:
	...
	ldr r0, _0211BF80 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211BFE4:
	...
	blx r1
_0211BFFC:
	ldr r0, _0211C290 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r3, r4, r5, r6, r7, pc}
...
FUN_ov23_0211c298: ; 0x0211C298
	...
	cmp r0, #0
	ldmeqfd sp!, {r3, r4, r5, r6, r7, pc}
	ldr r0, _0211C5F0 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldreqb r0, [r7, #0xf8]
