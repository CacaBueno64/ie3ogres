...
_0211E2F8:
	...
	streqb r6, [r0, #0x359]
_0211E308:
	ldr r0, _0211EA4C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov47_0211ea5c: ; 0x0211EA5C
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211EB4C ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r2]
	mov r7, r1
	mov r6, #0
...
FUN_ov47_0211ebd8: ; 0x0211EBD8
	...
	ldr r0, _0211ED44 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211EE18:
	...
	b _0211F03C
_0211EE28:
	ldr r0, _0211F074 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211F03C
...
FUN_ov47_0211f084: ; 0x0211F084
	...
	ldr r0, _0211F0F8 ; =gSprAnimeCtrl
	ldr r0, [r0]
