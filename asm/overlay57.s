...
_0211DC64:
	...
	mov r0, #1
	str r0, [sp, #0x18]
	ldr r0, _0211DCD8 ; =gSprAnimeCtrl
	ldr r3, [r4, #0x550]
	ldr r0, [r0]
	mov r2, r1
...
_0211DFD4:
	...
	str r1, [sp, #0x14]
	mov r2, #1
	ldr r0, _0211E230 ; =gSprAnimeCtrl
	str r2, [sp, #0x18]
	ldr r0, [r0]
	mov r3, r5
	bl FUN_ov16_0210e29c
...
_0211E4D4:
	...
	str r0, [sp, #0x10]
	str r5, [sp, #0x14]
	ldr r0, _0211E528 ; =gSprAnimeCtrl
	str r5, [sp, #0x18]
	ldr r0, [r0]
	mov r1, r5
	mov r2, r5
...
_0211E6EC:
	...
	bl FUN_ov16_0211346c
_0211E720:
	ldr r0, _0211E778 ; =gSprAnimeCtrl
	mov r1, r4
	ldr r0, [r0]
...
FUN_ov57_0211f914: ; 0x0211F914
	...
	ldr r2, _0212022C ; =gSprAnimeCtrl
	ldrh r3, [r3]
	mov r8, r1
	mov r9, r0
	orr r0, r3, r8
...
FUN_ov57_0212064c: ; 0x0212064C
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	sub sp, sp, #8
	ldr r2, _02120824 ; =gSprAnimeCtrl
	mov r5, r0
	ldr r0, [r2]
	mov r4, r1
	bl FUN_ov16_0210e15c
...
FUN_ov57_02120830: ; 0x02120830
	...
	ldr r0, _02120E54 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov57_02120e7c: ; 0x02120E7C
	stmfd sp!, {r3, r4, r5, lr}
	ldr r1, _02120F20 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r1]
	bl FUN_ov16_0210e15c
	cmp r0, #0
...
_021212D0:
	...
	ldr r0, _02121694 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _021215F4
...
_021217A8:
	...
	ldr r0, _0212194C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov57_02121df4: ; 0x02121DF4
	...
	str r5, [sp, #0xc]
	str r2, [sp, #0x10]
	ldr r4, _02121E68 ; =gSprAnimeCtrl
	ldrb r1, [r7, #0x11]
	ldrh r3, [r7, #0x34]
	ldr r0, [r4]
...
FUN_ov57_02121e6c: ; 0x02121E6C
	...
	ldrsh r1, [r0, #0x30]
	mov r2, #1
	ldr r12, _02121ECC ; =gSprAnimeCtrl
	cmp r1, #9
	moveq r1, r2
	movne r1, #0
	cmp r1, #0
...
FUN_ov57_021222d0: ; 0x021222D0
	...
	mov r9, r0
	str r7, [sp, #0x10]
	ldr r4, _0212236C ; =gSprAnimeCtrl
	ldrb r1, [r9, #0x11]
	ldrh r3, [r9, #0x34]
	ldr r0, [r4]
	mov r2, r7
