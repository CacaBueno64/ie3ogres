...
_0211D080:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x6b]
	ldr r0, _0211D0E4 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
_0211D1F8:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r8, #0x69]
	ldr r0, _0211D2B8 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r8, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov20_0211d670: ; 0x0211D670
	...
	ldr r2, _0211DC90 ; =gSprAnimeCtrl
	ldrh r3, [r3]
	mov r8, r1
	mov r9, r0
	orr r0, r3, r8
...
FUN_ov20_0211dcb4: ; 0x0211DCB4
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211DD90 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r2]
	mov r7, r1
	mov r6, #0
...
FUN_ov20_0211e118: ; 0x0211E118
	...
	ldr r0, _0211E290 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211E384:
	...
	b _0211E568
_0211E3AC:
	ldr r0, _0211E594 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211E568
...
_0211E568:
	...
	ldr r1, _0211E594 ; =gSprAnimeCtrl
	ldr r2, [r0]
	ldr r0, [r1]
	mov r1, r2, lsl #1
...
FUN_ov20_0211e5a0: ; 0x0211E5A0
	...
	ldr r0, _0211E630 ; =gSprAnimeCtrl
	ldr r0, [r0]
