...
FUN_ov40_0211a608: ; 0x0211A608
	...
	ldr r0, _0211A730 ; =gSprAnimeCtrl
	mov r8, #0
	ldr r0, [r0]
...
FUN_ov40_0211a738: ; 0x0211A738
	...
	ldr r0, _0211AA48 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r4, r5, r6, r7, r8, pc}
...
_0211C1A0:
	...
	ldr r0, _0211C2C8 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211C300:
	...
	bl FUN_02046e28
_0211C33C:
	ldr r0, _0211C504 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldreq r0, [r4, #4]
...
_0211C5B0:
	...
	ldr r0, _0211C6AC ; =gSprAnimeCtrl
	ldr r0, [r0]
