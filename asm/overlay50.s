...
_0211A79C:
	...
	movs r8, r0
	beq _0211A840
	ldr r0, _0211A864 ; =pLogic_PalSkinFaceFile
	ldr r1, [r8, #4]
	ldr r2, [r0]
	mov r0, r9
...
_0211A864: .word pLogic_PalSkinFaceFile
...
_0211CFC4:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x6b]
	ldr r0, _0211D028 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
_0211D13C:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r8, #0x69]
	ldr r0, _0211D1FC ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r8, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov50_0211d550: ; 0x0211D550
	...
	ldr r2, _0211DB4C ; =gSprAnimeCtrl
	ldrh r3, [r3]
	mov r8, r1
	mov r9, r0
	orr r0, r3, r8
...
FUN_ov50_0211db74: ; 0x0211DB74
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211DC48 ; =gSprAnimeCtrl
	mov r7, r0
	ldr r0, [r2]
	mov r6, r1
	mov r5, #0
...
FUN_ov50_0211dfec: ; 0x0211DFEC
	...
	ldr r0, _0211E120 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211E214:
	...
	b _0211E3CC
_0211E23C:
	ldr r0, _0211E3E8 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211E3CC
...
_0211E3CC:
	...
	ldr r1, _0211E3E8 ; =gSprAnimeCtrl
	ldr r2, [r0]
	ldr r0, [r1]
	mov r1, r2, lsl #1
	bl FUN_ov16_0210e10c
	ldmfd sp!, {r4, pc}
_0211E3E8: .word gSprAnimeCtrl
...
FUN_ov50_0211e3f4: ; 0x0211E3F4
	...
	ldr r0, _0211E47C ; =gSprAnimeCtrl
	ldr r0, [r0]
