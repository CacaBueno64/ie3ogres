	...
	.text
;	arm_func_start L5FS_AllocateFileBuffers ; https://decomp.me/scratch/KPamd
;L5FS_AllocateFileBuffers: ; 0x02085CE4
...
;	arm_func_end L5FS_AllocateFileBuffers
;
;	arm_func_start L5FS_ReadUncompressedFileDeferred ; https://decomp.me/scratch/wRtCI
;L5FS_ReadUncompressedFileDeferred: ; 0x02085D7C
...
;	mov r0, r6
;	str r1, [sp, #0xc]
;	bl L5FS_GetFileHandle
;	add r1, sp, #0xc
;	mov r2, r4
;	mov r3, r8
;	str r7, [sp]
;	mov r6, r0
;	bl L5FS_AllocateFileBuffers
;	ldr r1, [sp, #4]
;	str r1, [r6, #0xc]
;	ldr r1, [sp, #8]
;	str r1, [r6, #0x10]
...
;	arm_func_end L5FS_ReadUncompressedFileDeferred
;
;	arm_func_start L5FS_OpenArchiveDirect ; https://decomp.me/scratch/VtW1A
;L5FS_OpenArchiveDirect: ; 0x02085E4C
...
;	arm_func_end L5FS_OpenArchiveDirect
;
;	arm_func_start L5FS_OpenArchiveDeferred ; https://decomp.me/scratch/BXSNN
;L5FS_OpenArchiveDeferred: ; 0x02085F50
;	stmfd sp!, {r4, r5, r6, r7, lr}
;	sub sp, sp, #0x104
;	mov r4, r1
;	mov r6, r0
...
;	arm_func_end L5FS_OpenArchiveDeferred
;
;	arm_func_start FUN_02086040 ; https://decomp.me/scratch/eWV6q
...
;
;	arm_func_start FUN_02086080 ; https://decomp.me/scratch/6DTen
...
;
;	arm_func_start L5FS_ReadFileByID ; https://decomp.me/scratch/hnyI3
;L5FS_ReadFileByID: ; 0x02086110
...
;	arm_func_end L5FS_ReadFileByID
;
;	arm_func_start FUN_0208622c ; https://decomp.me/scratch/WnmuY
...
;	add r2, r5, #8
;	ldmia r2, {r2, r3}
;	bl L5FS_ReadFileByID
;	ldmfd sp!, {r3, r4, r5, r6, r7, pc}
;_02086280: .word unk_020BC5D0
;	arm_func_end FUN_0208622c
;
;	arm_func_start FUN_02086284 ; https://decomp.me/scratch/g1yNV
...
;
;	arm_func_start L5FS_AllocateFileHandle ; https://decomp.me/scratch/uDMXp
;L5FS_AllocateFileHandle: ; 0x02086314
;	stmfd sp!, {r0, r1, r2, r3}
...
;	add sp, sp, #0x10
;	bx lr
;	arm_func_end L5FS_AllocateFileHandle
;
;	arm_func_start FUN_02086390 ; https://decomp.me/scratch/bmYg3
...
;	mov r0, r8
;	ldmia r2, {r2, r3}
;	bl L5FS_AllocateFileHandle
;	add sp, sp, #8
;	ldmfd sp!, {r4, r5, r6, r7, r8, pc}
;_020863F8: .word unk_020BC5D0
;	arm_func_end FUN_02086390
;
;	arm_func_start FUN_020863fc ; https://decomp.me/scratch/7rMYX
...
;
;	arm_func_start FUN_020864b4 ; https://decomp.me/scratch/gFTuZ
...
;
;	arm_func_start FUN_02086564 ; https://decomp.me/scratch/D1XPj
...
;
;	arm_func_start FUN_020865cc ; https://decomp.me/scratch/xhvOv
...
;
;	arm_func_start FUN_02086640 ; https://decomp.me/scratch/M7Exs
...
;
;	arm_func_start FUN_02086684 ; https://decomp.me/scratch/fnn1h
