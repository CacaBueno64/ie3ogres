...
FUN_ov48_02119fb4: ; 0x02119FB4
	...
	ldr r11, _0211A06C ; =g3DPlaneCtrl
	b _0211A054
_02119FEC:
	ldr r2, [r7, r9, lsl #2]
...
FUN_ov48_0211a24c: ; 0x0211A24C
	...
	ldr r2, _0211A284 ; =gSprButtonCtrl
	mov r5, r0
	ldr r0, [r2]
	mov r4, r1
	mov r1, #1
...
FUN_ov48_0211a638: ; 0x0211A638
	...
	mov r0, #0x64
	str r0, [sp]
	ldr r0, _0211A770 ; =gSprButtonCtrl
	ldrh r2, [sp, #0x20]
	ldr r0, [r0]
	mov r1, r5
	mov r3, r7
...
_0211A76C: .word g3DPlaneCtrl
_0211A770: .word gSprButtonCtrl
...
FUN_ov48_0211a774: ; 0x0211A774
	stmfd sp!, {r3, r4, r5, r6, r7, r8, lr}
	sub sp, sp, #0x24
	ldr r3, _0211A814 ; =gSprButtonCtrl
	mov r8, r0
	ldr r0, [r3]
	mov r4, #1
	mov r7, r1
...
FUN_ov48_0211ac24: ; 0x0211AC24
	...
	mov r2, #6
	ldr r0, [r0, #4]
	ldr r12, _0211AC3C ; =_ZN14CScreenManager13fadeMainBlackEv
	str r2, [r1, #0x5e4]
	bx r12
_0211AC3C: .word _ZN14CScreenManager13fadeMainBlackEv
...
FUN_ov48_0211ac40: ; 0x0211AC40
	...
	mov r5, r0
	bne _0211AC60
	ldr r0, _0211AC74 ; =gSprButtonCtrl
	mov r1, #0x64
	ldr r0, [r0]
...
FUN_ov48_0211ac78: ; 0x0211AC78
	...
	cmp r4, #0
	ldmlefd sp!, {r4, pc}
	ldr r0, _0211ACA0 ; =gSprButtonCtrl
	mov r1, r4, lsl #0x10
	ldr r0, [r0]
	mov r1, r1, lsr #0x10
	bl FUN_ov16_0210e7d0
	ldmfd sp!, {r4, pc}
_0211ACA0: .word gSprButtonCtrl
...
FUN_ov48_0211aca4: ; 0x0211ACA4
	...
	ldr r4, _0211ACE0 ; =gSprButtonCtrl
	mov r1, r5, lsl #0x10
	ldr r0, [r4]
	mov r1, r1, lsr #0x10
	bl FUN_ov16_0210e7d0
...
FUN_ov48_0211ad18: ; 0x0211AD18
	stmfd sp!, {r4, r5, r6, lr}
	ldr r2, _0211ADB0 ; =gSprAnimeCtrl
	mov r5, r0
	ldr r0, [r2]
	mov r4, r1
	...
	cmp r0, #0
	ldmnefd sp!, {r4, r5, r6, pc}
	ldr r6, _0211ADB4 ; =gSprButtonCtrl
	ldr r0, [r6]
...
FUN_ov48_0211adbc: ; 0x0211ADBC
	...
	ldr r4, _0211AE48 ; =gSprButtonCtrl
	mov r1, r6
	ldr r0, [r4]
	mov r2, r5
...
FUN_ov48_0211ae4c: ; 0x0211AE4C
	...
	mov r2, r0, lsr #8
	add r0, r4, #0x5000
	ldr r1, _0211AEEC ; =gSprButtonCtrl
	str r2, [r0, #0x6e0]
	ldr r0, [r1]
	bl FUN_ov16_0210e980
	ldr r0, _0211AEF0 ; =gSprAnimeCtrl
	ldr r0, [r0]
	...
	mov r2, #0xa8
	bl MI_CpuFill8
	ldr r0, _0211AEF4 ; =g3DPlaneCtrl
	ldr r0, [r0]
	bl FUN_ov16_021123b4
	ldmfd sp!, {r3, r4, r5, pc}
_0211AEEC: .word gSprButtonCtrl
_0211AEF0: .word gSprAnimeCtrl
_0211AEF4: .word g3DPlaneCtrl
...
_0211AFBC:
	ldr r0, _0211B08C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211B074
...
_0211B074:
	ldr r0, _0211B08C ; =gSprAnimeCtrl
	ldr r1, _0211B090 ; =gDeltaTime
	ldr r0, [r0]
	ldr r1, [r1]
	bl FUN_ov16_0210e10c
	ldmfd sp!, {r3, r4, r5, pc}
_0211B08C: .word gSprAnimeCtrl
_0211B090: .word gDeltaTime
...
FUN_ov48_0211b098: ; 0x0211B098
	...
	bic r0, r1, #0x1f00
	orr r1, r0, r3, lsl #8
	ldr r0, _0211B0EC ; =gSprButtonCtrl
	str r1, [r2]
	ldr r0, [r0]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _0211B0F0 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0d8
	mov r0, r4
	bl FUN_ov48_0211a104
	ldr r0, _0211B0F4 ; =g3DPlaneCtrl
	ldr r0, [r0]
	bl FUN_ov16_021123c4
	ldmfd sp!, {r4, pc}
_0211B0EC: .word gSprButtonCtrl
_0211B0F0: .word gSprAnimeCtrl
...
ov48_0211B218:
	...
	.word ov48_0211B258
	.word ov48_0211B288
	.global ov48_0211B240
ov48_0211B240:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x69, 0x30, 0x34, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B24C
ov48_0211B24C:
	.byte 0x6A, 0x6B, 0x64, 0x6E
	.byte 0x5F, 0x62, 0x30, 0x31, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B258
ov48_0211B258:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x6E, 0x30, 0x30
	.byte 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B264
ov48_0211B264:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x69, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B270
ov48_0211B270:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x69, 0x30, 0x31, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B27C
ov48_0211B27C:
	.byte 0x6A, 0x6B, 0x64, 0x6E
	.byte 0x5F, 0x62, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B288
ov48_0211B288:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x77, 0x30, 0x30
	.byte 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B294
ov48_0211B294:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x69, 0x30, 0x32, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B2A0
ov48_0211B2A0:
	.byte 0x6A, 0x6B, 0x64, 0x6E, 0x5F, 0x69, 0x30, 0x33, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B2AC
ov48_0211B2AC:
	.byte 0x6A, 0x6B, 0x64, 0x6E
	.byte 0x5F, 0x62, 0x67, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.global ov48_0211B2C0
ov48_0211B2C0:
	.word FUN_ov48_0211b0f8
	.word FUN_ov48_0211b0fc
	.word FUN_ov48_0211ad18
	.word FUN_ov48_0211adbc
	.word FUN_ov48_0211ae4c
	.word _ZN12CommonScreen7vFUN_14Ev
	.word FUN_ov48_0211aef8
	.word FUN_ov48_0211b094
	.word FUN_ov48_0211b098
