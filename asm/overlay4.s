...
FUN_ov4_020bfa4c: ; 0x020BFA4C
	...
	tst r1, #1
	ldmeqfd sp!, {r3, pc}
	ldr r0, _020BFA70 ; =gMovie
	bl _ZN5Movie12FUN_0202e958Ev
	ldmfd sp!, {r3, pc}
_020BFA70: .word gMovie
...
_020BFA9C:
	...
	cmp r0, #0
	beq _020BFAB0
	ldr r0, _020BFABC ; =gMovie
	bl _ZN5Movie12FUN_0202e958Ev
_020BFAB0:
	mov r0, #0
	strb r0, [r4, #0xc]
	ldmfd sp!, {r4, pc}
_020BFABC: .word gMovie
...
_020CAE00:
	...
	ldr r0, _020CB144 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_020CB224:
	...
	ldr r0, _020CB3DC ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov4_020cb438: ; 0x020CB438
	...
	ldr r0, [r0]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _020CB530 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0d8
	add r0, r4, #0x540
	mov r1, #0x29
