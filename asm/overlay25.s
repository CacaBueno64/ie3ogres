...
FUN_ov25_0211a5fc: ; 0x0211A5FC
	...
	ldr r1, [r1, #0x44]
	blx r1
	ldr r0, _0211A724 ; =gSprButtonCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e980
	ldr r0, _0211A728 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211A724: .word gSprButtonCtrl
_0211A728: .word gSprAnimeCtrl
_0211A72C: .word g3DPlaneCtrl
_0211A730: .word ov25_0211B8B8
_0211A734: .word ov25_0211B6AC
...
FUN_ov25_0211a73c: ; 0x0211A73C
	...
	sub sp, sp, #0x3ac
	ldr r1, _0211B22C ; =gDeltaTime
	ldr r4, _0211B230 ; =gSprAnimeCtrl
	mov r9, r0
	mov r5, #0
	ldr r0, [r4]
	ldr r1, [r1]
...
_0211A7E8:
	...
	mov r3, r4
	stmia sp, {r7, r8}
	ldr r4, _0211B238 ; =gSprButtonCtrl
	mov r1, r6
	ldr r0, [r4]
	mov r2, r6
...
_0211A9A8:
	...
	addne sp, sp, #0x3ac
	ldmnefd sp!, {r3, r4, r5, r6, r7, r8, r9, r10, pc}
	ldr r0, _0211B238 ; =gSprButtonCtrl
	mov r1, r6
	ldr r0, [r0]
...
_0211B224:
	add sp, sp, #0x3ac
	ldmfd sp!, {r3, r4, r5, r6, r7, r8, r9, r10, pc}
_0211B22C: .word gDeltaTime
_0211B230: .word gSprAnimeCtrl
_0211B234: .word g3DPlaneCtrl
_0211B238: .word gSprButtonCtrl
_0211B23C: .word ov25_0211B8F0
_0211B240: .word gLogicThink
...
_0211B2F0:
	...
	add r0, r10, #0x44
	bl FUN_ov16_021105c0
	ldr r0, _0211B340 ; =gSprButtonCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _0211B344 ; =gSprAnimeCtrl
	ldr r0, [r0]
	...
	ldmfd sp!, {r3, r4, r5, r6, r7, r8, r9, r10, r11, pc}
_0211B340: .word gSprButtonCtrl
_0211B344: .word gSprAnimeCtrl
_0211B348: .word g3DPlaneCtrl
...
FUN_ov25_0211b354: ; 0x0211B354
	...
	cmp r0, #0
	ldmeqfd sp!, {r4, r5, r6, pc}
	ldr r5, _0211B490 ; =gSprButtonCtrl
	ldr r0, [r5]
...
_0211B39C:
	...
	blx r1
_0211B3B4:
	ldr r0, _0211B494 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r4, r5, r6, pc}
...
_0211B480:
	...
	bl FUN_ov16_02110a04
	ldmfd sp!, {r4, r5, r6, pc}
_0211B490: .word gSprButtonCtrl
_0211B494: .word gSprAnimeCtrl
_0211B498: .word gAudioPlayer
...
FUN_ov25_0211b49c: ; 0x0211B49C
	...
	ldr r0, _0211B598 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r3, r4, r5, r6, r7, pc}
	ldr r4, _0211B59C ; =gSprButtonCtrl
	mov r6, #1
	ldr r0, [r4]
	mov r1, r5
	mov r2, r6
...
_0211B580:
	...
	bl _ZN11AudioPlayer12FUN_0202cf6cEm
	ldmfd sp!, {r3, r4, r5, r6, r7, pc}
_0211B598: .word gSprAnimeCtrl
_0211B59C: .word gSprButtonCtrl
...
FUN_ov25_0211b5a4: ; 0x0211B5A4
	...
	mov r3, #9
	mov r2, #0xb
	ldr r0, _0211B5D4 ; =gAudioPlayer
	mov r1, #1
	strb r3, [r4, #0x41]
	strb r2, [r4, #0x40]
	bl _ZN11AudioPlayer12FUN_0202cf6cEm
	ldmfd sp!, {r4, pc}
_0211B5D4: .word gAudioPlayer
...
FUN_ov25_0211b5d8: ; 0x0211B5D8
	...
	mov r3, #0
	mov r2, #0xb
	ldr r0, _0211B608 ; =gAudioPlayer
	mov r1, #1
	strb r3, [r4, #0x41]
	strb r2, [r4, #0x40]
	bl _ZN11AudioPlayer12FUN_0202cf6cEm
	ldmfd sp!, {r4, pc}
_0211B608: .word gAudioPlayer
...
FUN_ov25_0211b60c: ; 0x0211B60C
	...
	cmp r0, #8
	bne _0211B644
	ldr r0, _0211B66C ; =gSprButtonCtrl
	mov r1, #1
	ldr r0, [r0]
...
_0211B644:
	...
	bl FUN_ov16_02110b0c
_0211B65C:
	ldr r0, _0211B670 ; =gAudioPlayer
	mov r1, #1
	bl _ZN11AudioPlayer12FUN_0202cf6cEm
	ldmfd sp!, {r4, pc}
_0211B66C: .word gSprButtonCtrl
_0211B670: .word gAudioPlayer
...
ov25_0211B7AC:
	...
	.byte 0x00, 0x00, 0x00, 0x00
	.global ov25_0211B7C4
ov25_0211B7C4:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x62, 0x30, 0x31, 0x2E, 0x70, 0x61, 0x63
	.byte 0x5F, 0x00, 0x00, 0x00
	.global ov25_0211B7D4
ov25_0211B7D4:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x62, 0x30, 0x32, 0x2E, 0x70, 0x61, 0x63
	.byte 0x5F, 0x00, 0x00, 0x00
	.global ov25_0211B7E4
ov25_0211B7E4:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x62, 0x30, 0x33, 0x2E, 0x70, 0x61, 0x63
	.byte 0x5F, 0x00, 0x00, 0x00
	.global ov25_0211B7F4
ov25_0211B7F4:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x77, 0x30, 0x30, 0x2E, 0x70, 0x61, 0x63
	.byte 0x5F, 0x00, 0x00, 0x00
	.global ov25_0211B804
ov25_0211B804:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x77, 0x30, 0x31, 0x2E, 0x70, 0x61, 0x63
	.byte 0x5F, 0x00, 0x00, 0x00
	.global ov25_0211B814
ov25_0211B814:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x77, 0x30, 0x32, 0x2E, 0x70, 0x61, 0x63
	.byte 0x5F, 0x00, 0x00, 0x00
	.global ov25_0211B824
ov25_0211B824:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x62, 0x67, 0x30, 0x30, 0x2E, 0x70, 0x61
	.byte 0x63, 0x5F, 0x00, 0x00
	.global ov25_0211B834
ov25_0211B834:
	.byte 0x70, 0x77, 0x64, 0x6E, 0x5F, 0x62, 0x67, 0x30, 0x32, 0x2E, 0x70, 0x61
	.byte 0x63, 0x5F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.global ov25_0211B84C
ov25_0211B84C:
	.word FUN_ov25_0211b694
	.word FUN_ov25_0211b674
	.word FUN_ov25_0211b354
	.word FUN_ov25_0211b49c
	.word FUN_ov25_0211a5fc
	.word _ZN12CommonScreen7vFUN_14Ev
	.word FUN_ov25_0211a73c
	.word FUN_ov25_0211b350
	.word FUN_ov25_0211b258
