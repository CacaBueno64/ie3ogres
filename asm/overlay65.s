...
FUN_ov65_0211a644: ; 0x0211A644
	...
	ldr r12, _0211A658 ; =FUN_0210EFAC
	ldr r0, [r0]
	bx r12
_0211A654: .word 0x02099EB4
_0211A658: .word FUN_0210EFAC
...
FUN_ov65_0211add0: ; 0x0211ADD0
	ldr r12, _0211ADE4 ; =MemWrite
	add r0, r0, #0x35c
	mov r1, #0
	mov r2, #0x18
	bx r12
_0211ADE4: .word MemWrite
...
FUN_ov65_0211b570: ; 0x0211B570
	...
	ldr r0, [r0]
	ldr r12, _0211B58C ; =FUN_02114204
	bx r12
_0211B584: .word 0x02099F38
_0211B588: .word 0x00007FFF
_0211B58C: .word FUN_02114204
...
FUN_ov65_0211b590: ; 0x0211B590
	...
	ldr r0, [r0]
	ldr r12, _0211B5AC ; =FUN_02114204
	bx r12
_0211B5A4: .word 0x02099F38
_0211B5A8: .word 0x00004210
_0211B5AC: .word FUN_02114204
...
FUN_ov65_0211b954: ; 0x0211B954
	ldr r12, _0211B968 ; =MemWrite
	add r0, r0, #0x3d0
	mov r1, #0
	mov r2, #8
	bx r12
_0211B968: .word MemWrite
...
FUN_ov65_0211bc44: ; 0x0211BC44
	ldr r12, _0211BC58 ; =MemWrite
	add r0, r0, #0x3d8
	mov r1, #0
	mov r2, #0xc
	bx r12
_0211BC58: .word MemWrite
...
FUN_ov65_0211c1ec: ; 0x0211C1EC
	ldr r12, _0211C200 ; =MemWrite
	add r0, r0, #0x3e8
	mov r1, #0
	mov r2, #0xc
	bx r12
_0211C200: .word MemWrite
...
FUN_ov65_0211c4e8: ; 0x0211C4E8
	ldr r12, _0211C4FC ; =MemWrite
	add r0, r0, #0x3f4
	mov r1, #0
	mov r2, #0x80
	bx r12
_0211C4FC: .word MemWrite
...
FUN_ov65_0211c920: ; 0x0211C920
	...
	mov r2, #0x24
	mla r0, r1, r2, r0
	ldr r12, _0211C93C ; =MemWrite
	mov r1, #0
	bx r12
_0211C93C: .word MemWrite
