...
FUN_ov0_020bdc58: ; 0x020BDC58
	...
	tst r1, #8
	ldmeqfd sp!, {r3, pc}
	ldr r0, _020BDC70 ; =gL5Movie
	bl _ZN7L5Movie12FUN_0202e958Ev
	ldmfd sp!, {r3, pc}
_020BDC70: .word gL5Movie
...
FUN_ov0_020cd1b8: ; 0x020CD1B8
	...
	ldr r1, _020CD1EC ; =gL5Allocator
	ldr r2, [r2, #0xc]
	bl FUN_ov0_020d2854
	mov r0, #1
	ldmfd sp!, {r3, pc}
_020CD1E8: .word unk_0209A200
_020CD1EC: .word gL5Allocator
...
FUN_ov0_020ce8d0: ; 0x020CE8D0
	...
	cmp r1, #0
	beq _020CE8EC
	ldr r0, _020CE8F8 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
_020CE8EC:
	mov r0, #0
	str r0, [r4, #0x18]
	ldmfd sp!, {r4, pc}
_020CE8F8: .word gL5Allocator
