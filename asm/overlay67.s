...
_0211C7A4:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x6a]
	ldr r0, _0211C808 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
_0211C8E4:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r9, #0x68]
	ldr r0, _0211C95C ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r9, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov67_0211d25c: ; 0x0211D25C
	...
	ldr r0, _0211D648 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov67_0211d658: ; 0x0211D658
	stmfd sp!, {r4, r5, r6, r7, r8, lr}
	ldr r2, _0211D740 ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r2]
	mov r8, r1
	mov r7, #0
...
FUN_ov67_0211d748: ; 0x0211D748
	...
	ldr r0, _0211DA0C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211D980:
	...
	ldr r0, _0211DA28 ; =gCameraController
	mov r1, #4
	ldr r6, [r0]
	mov r0, r6
...
_0211DA28: .word gCameraController
...
_0211DAE8:
	...
	bl FUN_ov67_0211c520
_0211DAFC:
	ldr r0, _0211DC40 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211DC04
...
FUN_ov67_0211dc50: ; 0x0211DC50
	...
	ldr r0, _0211DD38 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_021208B0:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x6a]
	ldr r0, _02120914 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
_021209F0:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r9, #0x68]
	ldr r0, _02120A68 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r9, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x20]
...
FUN_ov67_02121540: ; 0x02121540
	...
	cmp r1, #5
	ldmnefd sp!, {r3, r4, r5, r6, r7, pc}
	ldr r0, _021217FC ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r3, r4, r5, r6, r7, pc}
...
FUN_ov67_0212181c: ; 0x0212181C
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0212191C ; =gSprAnimeCtrl
	mov r5, r0
	ldr r0, [r2]
	mov r4, r1
	bl FUN_ov16_0210e15c
...
FUN_ov67_02121928: ; 0x02121928
	...
	mov r4, #1
	bl FUN_ov16_0210e980
	ldr r0, _02121BC8 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0a0
	mov r0, r6
	ldr r1, [r0]
...
_02121CF0:
	...
	bl FUN_ov67_02120e00
_02121D0C:
	ldr r0, _02121E7C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _02121E28
...
FUN_ov67_02121ec0: ; 0x02121EC0
	...
	ldr r0, [r1]
	bl FUN_ov16_0210e9d8 ; may be ov17 ; ov16(Mica)
	ldr r0, _02121F84 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e0d8
	ldr r1, [r6, #0x118]
	cmp r1, #0
