...
_0211C9FC:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r4, #0x66]
	ldr r0, _0211CA60 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r4, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x1c]
...
_0211CB74:
	...
	str r1, [sp, #0x18]
	ldrb r3, [r8, #0x64]
	ldr r0, _0211CC34 ; =gSprAnimeCtrl
	mov r2, r1
	add r3, r8, r3, lsl #2
	ldr r0, [r0]
	ldr r3, [r3, #0x1c]
...
FUN_ov51_0211d384: ; 0x0211D384
	...
	ldr r2, _0211DC10 ; =gSprAnimeCtrl
	ldrh r3, [r3]
	mov r8, r1
	mov r9, r0
	orr r0, r3, r8
...
FUN_ov51_0211dc20: ; 0x0211DC20
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211DCE8 ; =gSprAnimeCtrl
	mov r7, r0
	ldr r0, [r2]
	mov r6, r1
	mov r5, #0
...
FUN_ov51_0211dcf0: ; 0x0211DCF0
	...
	ldr r0, _0211DE28 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211DF00:
	ldr r0, _0211E06C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	bne _0211E04C
...
_0211E04C:
	...
	ldr r1, _0211E06C ; =gSprAnimeCtrl
	ldr r2, [r0]
	ldr r0, [r1]
	mov r1, r2, lsl #1
...
FUN_ov51_0211e07c: ; 0x0211E07C
	...
	ldr r0, _0211E0F0 ; =gSprAnimeCtrl
	ldr r0, [r0]
