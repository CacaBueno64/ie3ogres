...
FUN_ov44_0211af94: ; 0x0211AF94
	...
	ldr r12, _0211AFA8 ; =FUN_0210EFAC
	ldr r0, [r0]
	bx r12
_0211AFA4: .word 0x02099EB4
_0211AFA8: .word FUN_0210EFAC
...
FUN_ov44_0211c28c: ; 0x0211C28C
	add r0, r0, #0x374
	ldr r12, _0211C2A4 ; =MemWrite
	add r0, r0, #0x9000
	mov r1, #0
	mov r2, #0x18
	bx r12
_0211C2A4: .word MemWrite
...
FUN_ov44_0211d4ec: ; 0x0211D4EC
	add r0, r0, #0x530
	ldr r12, _0211D504 ; =MemWrite
	add r0, r0, #0x9000
	mov r1, #0
	mov r2, #8
	bx r12
_0211D504: .word MemWrite
...
FUN_ov44_0211d870: ; 0x0211D870
	add r0, r0, #0x1540
	ldr r12, _0211D888 ; =MemWrite
	add r0, r0, #0x8000
	mov r1, #0
	mov r2, #0x58
	bx r12
_0211D888: .word MemWrite
...
FUN_ov44_02120704: ; 0x02120704
	...
	mov r2, #0x24
	mla r0, r1, r2, r0
	ldr r12, _02120720 ; =MemWrite
	mov r1, #0
	bx r12
_02120720: .word MemWrite
