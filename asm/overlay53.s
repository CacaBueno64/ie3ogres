...
FUN_ov53_02119f00: ; 0x02119F00
	...
	ldr r0, _02119FF0 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov53_02119ff4: ; 0x02119FF4
	...
	ldr r0, _0211A0B4 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov53_0211a75c: ; 0x0211A75C
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r2, _0211A8CC ; =gSprAnimeCtrl
	mov r6, r0
	ldr r0, [r2]
	mov r5, r1
	mov r4, #0
...
_0211ABA0:
	...
	ldr r0, _0211ACC8 ; =gSprAnimeCtrl
...
FUN_ov53_0211bb14: ; 0x0211BB14
	stmfd sp!, {r3, r4, r5, r6, r7, lr}
	ldr r1, _0211BCDC ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r1]
	bl FUN_ov16_0210e15c
	cmp r0, #0
...
FUN_ov53_0211cedc: ; 0x0211CEDC
	...
	ldr r12, _0211CEF4 ; =_ZN11AudioPlayer12FUN_0202cf6cEm
	bx r12
_0211CEF0: .word gAudioPlayer
_0211CEF4: .word _ZN11AudioPlayer12FUN_0202cf6cEm
