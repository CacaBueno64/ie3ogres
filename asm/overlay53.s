...
FUN_ov53_0211a68c: ; 0x0211A68C
	...
	ldr r12, _0211A6A0 ; =FUN_0210EFAC
	ldr r0, [r0]
	bx r12
_0211A69C: .word 0x02099EB4
_0211A6A0: .word FUN_0210EFAC
...
FUN_ov53_0211b948: ; 0x0211B948
	...
	ldr r0, [r0]
	ldr r12, _0211B964 ; =FUN_02114204
	bx r12
_0211B95C: .word 0x02099F38
_0211B960: .word 0x00007FFF
_0211B964: .word FUN_02114204
...
FUN_ov53_0211b968: ; 0x0211B968
	...
	ldr r0, [r0]
	ldr r12, _0211B984 ; =FUN_02114204
	bx r12
_0211B97C: .word 0x02099F38
_0211B980: .word 0x00004210
_0211B984: .word FUN_02114204
...
FUN_ov53_0211bde0: ; 0x0211BDE0
	add r0, r0, #0xa8
	ldr r12, _0211BDF8 ; =MemWrite
	add r0, r0, #0x800
	mov r1, #0
	mov r2, #8
	bx r12
_0211BDF8: .word MemWrite
...
FUN_ov53_0211c01c: ; 0x0211C01C
	ldr r12, _0211C030 ; =MemWrite
	add r0, r0, #0x8b0
	mov r1, #0
	mov r2, #0x1c
	bx r12
_0211C030: .word MemWrite
...
FUN_ov53_0211c7c8: ; 0x0211C7C8
	add r0, r0, #0x14c
	ldr r12, _0211C7E0 ; =MemWrite
	add r0, r0, #0x800
	mov r1, #0
	mov r2, #0xc
	bx r12
_0211C7E0: .word MemWrite
...
FUN_ov53_0211ccf0: ; 0x0211CCF0
	ldr r12, _0211CD04 ; =MemWrite
	add r0, r0, #0x9f0
	mov r1, #0
	mov r2, #0xc
	bx r12
_0211CD04: .word MemWrite
...
FUN_ov53_0211d04c: ; 0x0211D04C
	add r0, r0, #0xcc
	ldr r12, _0211D064 ; =MemWrite
	add r0, r0, #0x800
	mov r1, #0
	mov r2, #0x80
	bx r12
_0211D064: .word MemWrite
...
FUN_ov53_0211d534: ; 0x0211D534
	...
	mov r2, #0x24
	mla r0, r1, r2, r0
	ldr r12, _0211D550 ; =MemWrite
	mov r1, #0
	bx r12
_0211D550: .word MemWrite
