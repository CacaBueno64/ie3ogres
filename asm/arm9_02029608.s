...
;	arm_func_start _ZN7L5MovieC1Ev
;_ZN7L5MovieC1Ev: ; 0x0202E474
;	mov r1, #0
;	str r1, [r0, #0x18c]
;	bx lr
;	arm_func_end _ZN7L5MovieC1Ev
;
;	arm_func_start _ZN7L5MovieD1Ev
;_ZN7L5MovieD1Ev: ; 0x0202E480
;	stmfd sp!, {r4, lr}
;	mov r4, r0
;	ldr r1, [r4, #0x18c]
;	cmp r1, #0
...
;	mov r0, r4
;	ldmfd sp!, {r4, pc}
;	arm_func_end _ZN7L5MovieD1Ev
;
;	arm_func_start _ZN7L5Movie12FUN_0202e4acEPv
;_ZN7L5Movie12FUN_0202e4acEPv: ; 0x0202E4AC
;	stmfd sp!, {r3, lr}
;	cmp r1, #0
;	ldmeqfd sp!, {r3, pc}
...
;	arm_func_end _ZN7L5Movie12FUN_0202e4acEPv
;
;	arm_func_start _ZN7L5Movie12FUN_0202e4ccEPtS0_S0_S0_
;_ZN7L5Movie12FUN_0202e4ccEPtS0_S0_S0_: ; 0x0202E4CC
...
;	arm_func_end _ZN7L5Movie12FUN_0202e4ccEPtS0_S0_S0_
;
;	arm_func_start _ZN7L5Movie12FUN_0202e4ecEv
;_ZN7L5Movie12FUN_0202e4ecEv: ; 0x0202E4EC
...
;	arm_func_end _ZN7L5Movie12FUN_0202e4ecEv
;
;	arm_func_start _ZN7L5Movie9playMovieEPcmmh ; https://decomp.me/scratch/i76s0
;_ZN7L5Movie9playMovieEPcmmh: ; 0x0202E520
...
;	bl _ll_udiv
;	adds r1, r5, #5
;	ldr r5, _0202E77C ; =Movie_AlarmIntr
;	mov r3, r0
;	stmib sp, {r5, r6}
;	adc r2, r7, #0
;	add r0, r8, #0x9c
...
;_0202E6E4:
;	mov r0, r8
;	bl _ZN7L5Movie12FUN_0202ea50Ev
;	add r6, r6, #1
;	cmp r6, #6
;	blt _0202E6E4
;	mov r4, #0x400
...
;_0202E770: .word gL5Sound
;_0202E774: .word 0x00000F42
;_0202E778: .word 0x000082EA
;_0202E77C: .word Movie_AlarmIntr
;_0202E780: .word FUN_0202ec08
;	arm_func_end _ZN7L5Movie9playMovieEPcmmh
;
;	arm_func_start _ZN7L5Movie12FUN_0202e784Ev
;_ZN7L5Movie12FUN_0202e784Ev: ; 0x0202E784
;	ldr r0, [r0, #0x18c]
;	bx lr
;	arm_func_end _ZN7L5Movie12FUN_0202e784Ev
;
;	arm_func_start _ZN7L5Movie12FUN_0202e78cEv ; https://decomp.me/scratch/OeIac
;_ZN7L5Movie12FUN_0202e78cEv: ; 0x0202E78C
;	stmfd sp!, {r3, r4, r5, lr}
;	mov r5, r0
;	ldr r2, [r5, #0x18c]
;	mov r4, #0
...
;_0202E954: .word gL5Sound
;	arm_func_end _ZN7L5Movie12FUN_0202e78cEv
;
;	arm_func_start _ZN7L5Movie12FUN_0202e958Ev
;_ZN7L5Movie12FUN_0202e958Ev: ; 0x0202E958
;	stmfd sp!, {r3, lr}
;	ldr r1, [r0, #0x18c]
;	tst r1, #2
;	ldmeqfd sp!, {r3, pc}
...
;	bl _ZN7L5Movie12FUN_0202e978Ev
;	ldmfd sp!, {r3, pc}
;	arm_func_end _ZN7L5Movie12FUN_0202e958Ev
;
;	arm_func_start _ZN7L5Movie12FUN_0202e978Ev
;_ZN7L5Movie12FUN_0202e978Ev: ; 0x0202E978
;	stmfd sp!, {r3, lr}
;	ldr r1, [r0, #0x18c]
;	tst r1, #2
;	ldmeqfd sp!, {r3, pc}
...
;	str r1, [r0, #0x198]
;	ldmeqfd sp!, {r3, pc}
;	ldr r0, _0202E9C4 ; =gL5Sound
;	mov r1, #0
;	mov r2, #0x12c
;	bl _ZN7L5Sound12FUN_0202d774Emm
;	ldmfd sp!, {r3, pc}
;_0202E9C0: .word unk_020B5B80
;_0202E9C4: .word gL5Sound
;	arm_func_end _ZN7L5Movie12FUN_0202e978Ev
;
;	arm_func_start _ZN7L5Movie12FUN_0202e9c8Ev ; https://decomp.me/scratch/vggam
;_ZN7L5Movie12FUN_0202e9c8Ev: ; 0x0202E9C8
;	stmfd sp!, {r3, r4, r5, lr}
;	mov r5, r0
;	ldr r0, [r5, #0x18c]
;	tst r0, #0x10
...
;_0202EA4C: .word gL5Sound
;	arm_func_end _ZN7L5Movie12FUN_0202e9c8Ev
;
;	arm_func_start _ZN7L5Movie12FUN_0202ea50Ev ; https://decomp.me/scratch/Zd7ZV
;_ZN7L5Movie12FUN_0202ea50Ev: ; 0x0202EA50
;	stmfd sp!, {r4, lr}
;	mov r4, r0
;	ldr r0, [r4, #0x194]
;	cmp r0, #6
...
;	mov r0, #1
;	ldmfd sp!, {r4, pc}
;	arm_func_end _ZN7L5Movie12FUN_0202ea50Ev
;
;	arm_func_start _ZN7L5Movie9stopMovieEm ; https://decomp.me/scratch/voZqr
;_ZN7L5Movie9stopMovieEm: ; 0x0202EB00
;	stmfd sp!, {r4, r5, r6, lr}
;	mov r5, r0
;	ldr r0, [r5, #0x18c]
;	mov r4, r1
...
;
;	arm_func_start Movie_GetVideoFps
;Movie_GetVideoFps: ; 0x0202EC30
;	stmfd sp!, {r3, lr}
;	ldr r0, [r0, #0x98]
;	cmp r0, #0
;	moveq r0, #0
...
;	bl MO_GetVideoFps
;	ldmfd sp!, {r3, pc}
;	arm_func_end Movie_GetVideoFps
;
;	arm_func_start FUN_0202ec4c ; https://decomp.me/scratch/Zi5yK
...
;
;	arm_func_start Movie_AlarmIntr
;Movie_AlarmIntr: ; 0x0202ECD8
...
;	arm_func_end Movie_AlarmIntr
;
;	arm_func_start Movie_Malloc
;Movie_Malloc: ; 0x0202ECF0
...
;	arm_func_end Movie_Malloc
;
;	arm_func_start Movie_Free
;Movie_Free: ; 0x0202ED14
...
;	arm_func_end Movie_Free
;
;	arm_func_start MO_Malloc
;MO_Malloc: ; 0x0202ED30
;	ldr r12, _0202ED38 ; =Movie_Malloc
;	bx r12
;_0202ED38: .word Movie_Malloc
;	arm_func_end MO_Malloc
;
;	arm_func_start MO_Free
;MO_Free: ; 0x0202ED3C
;	ldr r12, _0202ED44 ; =Movie_Free
;	bx r12
;_0202ED44: .word Movie_Free
