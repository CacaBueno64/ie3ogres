...
FUN_ov52_0211a214: ; 0x0211A214
	...
	ldr r0, _0211A48C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
_0211A60C:
	...
	ldr r0, _0211A658 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov52_0211a660: ; 0x0211A660
	...
	ldr r5, _0211A90C ; =gSprAnimeCtrl
	mov r4, r0
	ldr r0, [r5]
	ldr r1, [r1]
...
FUN_ov52_0211a914: ; 0x0211A914
	...
	ldr r0, _0211A97C ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	addeq r0, r6, #0x1000
...
FUN_ov52_0211a980: ; 0x0211A980
	...
	ldr r0, _0211AA10 ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	addeq r0, r5, #0x1000
...
_0211E65C:
	...
	mov r1, r4
	bl FUN_0205a5e8
	ldr r0, _0211E708 ; =gCameraController
	mov r1, #4
	ldr r5, [r0]
	mov r0, r5
...
_0211E708: .word gCameraController
...
FUN_ov52_02121908: ; 0x02121908
	...
	str r0, [sp, #0xc]
	str r0, [sp, #0x10]
	ldr r0, _02121954 ; =gSprAnimeCtrl
	ldrb r1, [r5, #0x11]
	ldrb r2, [r5, #0x38]
	ldrh r3, [r5, #0x34]
	ldr r0, [r0]
...
FUN_ov52_02121958: ; 0x02121958
	...
	ldrh r1, [r5, #0x36]
	mov r4, #0
	ldr r0, _021219A0 ; =gSprAnimeCtrl
	stmia sp, {r1, r4}
	str r4, [sp, #8]
	str r4, [sp, #0xc]
	str r4, [sp, #0x10]
...
FUN_ov52_021219a4: ; 0x021219A4
	...
	ldr r4, _021219E4 ; =gSprAnimeCtrl
	mov r5, #4
	ldrb r1, [r6, #0x11]
	ldr r0, [r4]
	mov r2, r5
