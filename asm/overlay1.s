...
FUN_ov1_020d2804: ; 0x020D2804
	...
	str r4, [sp]
	bl FUN_ov1_020ce940
	ldr r0, _020D2884 ; =gL5Sound
	mov r1, #3
	bl FUN_0202cf6c
	add sp, sp, #4
	ldmfd sp!, {r3, r4, r5, r6, r7, r8, pc}
_020D2880: .word unk_02099EF0
_020D2884: .word gL5Sound
...
FUN_ov1_020d351c: ; 0x020D351C
	...
	cmp r0, #0
	ldmeqfd sp!, {r4, pc}
	ldr r0, _020D3548 ; =gL5Sound
	mov r1, #4
	bl FUN_0202cf6c
	ldmfd sp!, {r4, pc}
_020D3548: .word gL5Sound
...
FUN_ov1_020d354c: ; 0x020D354C
	...
	addeq sp, sp, #4
	ldmeqfd sp!, {r3, r4, pc}
	ldr r0, _020D358C ; =gL5Sound
	mov r1, #3
	bl FUN_0202cf6c
	add sp, sp, #4
	ldmfd sp!, {r3, r4, pc}
_020D358C: .word gL5Sound
...
FUN_ov1_020d83ec: ; 0x020D83EC
	...
	tst r1, #8
	ldmeqfd sp!, {r3, pc}
	ldr r0, _020D8404 ; =gL5Movie
	bl _ZN7L5Movie12FUN_0202e958Ev
	ldmfd sp!, {r3, pc}
_020D8404: .word gL5Movie
