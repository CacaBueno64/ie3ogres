...
_0206F1BC:
	...
	arm_func_start _ZN17UnkClass_0209BA2012FUN_0206f1e0Ev
_ZN17UnkClass_0209BA2012FUN_0206f1e0Ev: ; 0x0206F1E0
	mov r1, #0
	str r1, [r0, #0x7d0]
	str r1, [r0, #0x7d4]
	str r1, [r0, #0x7d8]
	...
	str r1, [r0, #0x800]
	bx lr
	arm_func_end _ZN17UnkClass_0209BA2012FUN_0206f1e0Ev

	arm_func_start _ZN17UnkClass_0209BA2012FUN_0206f244Ev
_ZN17UnkClass_0209BA2012FUN_0206f244Ev: ; 0x0206F244
	stmfd sp!, {r3, r4, r5, lr}
...
_0206F298: .word 0x0000FFFF
	arm_func_end _ZN17UnkClass_0209BA2012FUN_0206f244Ev
...
_0206F778: .word unk_020A0B00
	...
	arm_func_start _ZN17UnkClass_0209BA2012FUN_0206f77cEv
_ZN17UnkClass_0209BA2012FUN_0206f77cEv: ; 0x0206F77C
	stmfd sp!, {r3, r4, lr}
	sub sp, sp, #0x14
	mov r12, #0
	mov r4, r0
...
_0206F820:
	...
	add sp, sp, #0x14
	ldmfd sp!, {r3, r4, pc}
_0206F82C: .word gL5Allocator
_0206F830: .word unk_02091350
	arm_func_end _ZN17UnkClass_0209BA2012FUN_0206f77cEv
...
_020715B0: .word 0x00000101
	...
	arm_func_start _ZN17UnkClass_0209BA2012FUN_020715b4Ev
_ZN17UnkClass_0209BA2012FUN_020715b4Ev: ; 0x020715B4
	stmfd sp!, {r3, r4, r5, lr}
	sub sp, sp, #0x10
	mov r5, r0
	ldr r0, [r5, #0x814]
...
FUN_02071934: ; 0x02071934
	...
	moveq r0, #1
	ldmeqfd sp!, {r4, pc}
	ldr r0, _02071964 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, #0
	str r0, [r4, #0x808]
	mov r0, #1
	ldmfd sp!, {r4, pc}
_02071964: .word gL5Allocator
...
FUN_02072020: ; 0x02072020
	...
	moveq r0, #1
	ldmeqfd sp!, {r4, pc}
	ldr r0, _02072050 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, #0
	str r0, [r4, #0x7f0]
	mov r0, #1
	ldmfd sp!, {r4, pc}
_02072050: .word gL5Allocator
...
FUN_02073358: ; 0x02073358
	...
	cmp r1, #0
	ldmeqfd sp!, {r4, pc}
	ldr r0, _02073380 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, #0
	str r0, [r4, #0x82c]
	ldmfd sp!, {r4, pc}
_02073380: .word gL5Allocator
...
FUN_020736e8: ; 0x020736E8
	...
	moveq r0, #1
	ldmeqfd sp!, {r4, pc}
	ldr r0, _02073718 ; =gL5Allocator
	bl _ZN11L5Allocator10deallocateEPv
	mov r0, #0
	str r0, [r4, #0x830]
	mov r0, #1
	ldmfd sp!, {r4, pc}
_02073718: .word gL5Allocator
