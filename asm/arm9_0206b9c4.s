...
;	arm_func_start _ZN6Thread4InitEv
;_ZN6Thread4InitEv: ; 0x0206EDC0
;	mov r2, #0
...
;	arm_func_end _ZN6Thread4InitEv
;
...
;
;	arm_func_start _ZN6Thread5YieldEv
;_ZN6Thread5YieldEv: ; 0x0206EE5C
;	str lr, [sp, #-4]!
;	str r11, [sp, #-4]!
;	str r10, [sp, #-4]!
;	str r9, [sp, #-4]!
...
;	arm_func_end _ZN6Thread5YieldEv
;
...
;
;	arm_func_start _ZN6Thread5SleepEi
;_ZN6Thread5SleepEi: ; 0x0206EED0
;	stmfd sp!, {r3, r4, r5, lr}
;	mov r5, r0
;	mov r4, #0
;	cmp r5, #0
...
;	blt _0206EEE4
;	ldmfd sp!, {r3, r4, r5, pc}
;	arm_func_end _ZN6Thread5SleepEi
;
...
;
;	arm_func_start _ZN6Thread9InitStackEPFvPvES0_S0_
;_ZN6Thread9InitStackEPFvPvES0_S0_: ; 0x0206EF20
;	str r0, [r2, #-4]!
;	str r11, [r2, #-4]!
;	str r10, [r2, #-4]!
;	str r9, [r2, #-4]!
...
;	arm_func_end _ZN6Thread9InitStackEPFvPvES0_S0_
;
;	arm_func_start _ZN6Thread6CreateEPFvPvES0_S0_
;_ZN6Thread6CreateEPFvPvES0_S0_: ; 0x0206EFA0
;	stmfd sp!, {r4, lr}
;	mov r4, r0
;	ldr r0, _0206EFBC ; =L5Thread_Starter
;	bl _ZN6Thread9InitStackEPFvPvES0_S0_
;	ldr r1, _0206EFC0 ; =0x020B9D94
;	str r4, [r1, r0, lsl #2]
;	ldmfd sp!, {r4, pc}
;_0206EFBC: .word L5Thread_Starter
;_0206EFC0: .word unk_020B9D94
;	arm_func_end _ZN6Thread6CreateEPFvPvES0_S0_
;
;	arm_func_start _ZN6Thread7DestroyEi
;_ZN6Thread7DestroyEi: ; 0x0206EFC4
;	ldr r1, _0206EFD4 ; =0x020B9D54
;	mov r2, #0
;	str r2, [r1, r0, lsl #2]
;	bx lr
;_0206EFD4: .word unk_020B9D54
;	arm_func_end _ZN6Thread7DestroyEi
;
...
;
;	arm_func_start _ZN6Thread9WakeUpAllEv
;_ZN6Thread9WakeUpAllEv: ; 0x0206F014
;	mov r1, #0
...
;	arm_func_end _ZN6Thread9WakeUpAllEv
