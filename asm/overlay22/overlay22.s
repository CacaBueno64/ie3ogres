...
#ifdef LANGUAGE_FRENCH
	.ascii "En quittant le tournoi, vous\nd"
		.byte 0xBA
		.asciz "clarez forfait. Quitter ?"
	.balign 4, 0
#else
...
#ifdef LANGUAGE_FRENCH
	.asciz "Quitter sans sauvegarder le tournoi ?"
	.balign 4, 0
#else
