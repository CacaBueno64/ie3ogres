...
FUN_ov70_0211dae4: ; 0x0211DAE4
	...
	strh r4, [r0, #0x38]
_0211DB58:
	ldr r0, _0211DF04 ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov70_0211df0c: ; 0x0211DF0C
	...
	ldr r0, _0211E3CC ; =gSprAnimeCtrl
	ldr r0, [r0]
	bl FUN_ov16_0210e15c
	cmp r0, #0
	ldmnefd sp!, {r3, r4, r5, r6, r7, r8, r9, pc}
...
FUN_ov70_0211e3d8: ; 0x0211E3D8
	...
	ldr r0, _0211E69C ; =gSprAnimeCtrl
	ldr r0, [r0]
...
FUN_ov70_0211e6a4: ; 0x0211E6A4
	...
	ldr r4, _0211EF34 ; =gSprAnimeCtrl
	mov r9, r0
	mov r5, #0
	ldr r0, [r4]
	ldr r1, [r1]
...
FUN_ov70_0211ef44: ; 0x0211EF44
	...
	ldr r0, _0211EFA0 ; =gSprAnimeCtrl
	ldr r0, [r0]
