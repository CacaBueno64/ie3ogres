...
void AudioPlayer::initDSE(Allocator *allocator)
{
...
BOOL AudioPlayer::FUN_0202d184(int param1)
{
    ...
    if ((this->unkC0[param1].unk6 & 0x2) && (DSE_SsdIsPlaySequence(this->unk58[this->unkC0[param1].unk3].sequence) > 0)) {
        return TRUE;
    }
        ...
        if (this->unkC0[i].unk4 & 0x2) {
            if (this->unkC0[i].unk6 & 0x1) {
                if ((this->unkC0[i].unk6 & 0x2) == FALSE) {
                    ...
                    this->setPlayParamVolume(((this->bgmVolume * this->bgmGain * this->unk258) >> 7) / 1000, this->unkC0[i].fadeTime);
